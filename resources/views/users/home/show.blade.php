            ...
            <div class="row g-4 mb-5">
                        ...
                        <div class="col-lg-12">
                            <nav>
                                <div class="nav nav-tabs mb-3">
                                    <button class="nav-link active border-bottom-0 border-white" type="button"
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="border-bottom rounded">
                                        <input type="text" class="form-control me-4 border-0"
                ...
                <div class="col-lg-4 col-xl-3">
                    <div class="row g-4 fruite">
                        <div class="col-lg-12">
                            <div class="input-group w-100 d-flex mx-auto mb-4">
            ...
            <div class="vesitable">
                <div
                    ...
                    @foreach ($relatedProducts as $relatedProduct)
                        <div class="border-primary position-relative vesitable-item mx-2 rounded border"
                            style="width: 300px;">
                            <div class="vesitable-img">
                                <img src="{{ asset('products/' . $relatedProduct->image) }}"
